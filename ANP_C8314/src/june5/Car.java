...
public class Car {
	...
	// ab jo humaare  features hai that is called state 
	//and behaiour is called behaviour of class
	
	// phir class se object bante jaate hai  jese ki male class se sachin , rahul ,piyush 
	
	
	// class  jo bhi ban rahi hai vo kabhi exist nahi hoti hai it not present physically  
	...
	// ye method hai ( function jese hi hai )
	public String  giveHorn() {
//		
